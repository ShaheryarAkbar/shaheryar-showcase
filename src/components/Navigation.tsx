          ...
          {navLinks.map((link) => (
            <li key={link.name}>
              <a
                ...
                className="text-foreground hover:text-primary transition-smooth cursor-pointer font-medium"
              >
                {link.name}
              </a>
            </li>
            ...
            {navLinks.map((link) => (
              <li key={link.name}>
                <a
                  ...
                  className="block text-lg text-foreground hover:text-primary transition-smooth cursor-pointer font-medium"
                >
                  {link.name}
                </a>
              </li>
